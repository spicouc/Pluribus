...
class SecurityWorkflowTests(unittest.TestCase):
    ...
    def _assert_actions_are_sha_pinned(self, content: str) -> None:
        ...
        for line in uses_lines:
            self.assertRegex(
                line,
                SHA_ACTION,
                msg=f"Action no pinnejada per SHA: {line}",
            )
    ...
    def test_dependency_review_stays_deferred_until_control_plane_is_enabled(self) -> None:
        self.assertFalse((WORKFLOWS / "dependency-review.yml").exists())
